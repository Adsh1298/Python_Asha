...
# filter=['Austraila','USA','Canada','South Korea','France']
# for country in fuel:
...
#histogram example
# bins = [40, 50, 60, 70, 80, 90, 100]#bins defines the column structure of the
# # histogram.
...
# plt.figure(figsize=(10,10))
# plt.scatter(fifa['SlidingTackle'], fifa['Overall'], color='green')
# plt.title("Sliding Tackle vs. Rating")
# plt.xlabel("Skill Moves")
# plt.ylabel("Rating")
# plt.show()

#######################Create a pie chart for players with left and right foot
# comparison
